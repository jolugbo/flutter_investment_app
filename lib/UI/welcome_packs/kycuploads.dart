                                ...
                                setState(() {
                                  ...
                                  switch (_currentPage) {
                                    ...
                                    case 2:
                                      ...
                                      bodyText =
                                          'Write your signature on a piece of plain paper and take a clear picture of your signature';
                                      break;
                                    case 3:
                                      _currentPage = 2;
                                      sliderPosition = 0;
                                    ...
                                    Container(
                                      margin: EdgeInsets.fromLTRB(
                                          ...
                                          MediaQuery.of(context).size.width *
                                              0.05),
                                      child: Text(
                                        'Your profile validation documents have been successfully uploaded for review',
                                        style: purple18Style,
                                        textAlign: TextAlign.center,
                                      ),
                                    ),
                                    ...
                                    Container(
                                      margin: EdgeInsets.fromLTRB(
                                          ...
                                          MediaQuery.of(context).size.width *
                                              0.05),
                                      child: Text(
                                        'You will receive an email from us with the status of your profile validation in under 24 hours (excluding weekdays and public holidays)',
                                        style: purple14Style,
                                        textAlign: TextAlign.left,
                                      ),
                                    ),
